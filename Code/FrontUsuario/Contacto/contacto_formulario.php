	...
	<body>
                        ...
                        <nav class="navigation navbar navbar-expand-md navbar-dark ">
                           ...
                           <div class="collapse navbar-collapse" id="navbarsExample04">
                              <ul class="navbar-nav mr-auto">
								 ...
								 <li class="nav-item">
                                    <a class="nav-link" href="../Contacto/contacto_formulario.php">Contactos</a>
                                 </li>
								 <li class="nav-item">
		...
		<div class="right">
			<form action = "cuentaskillup@gmail.com", method = 'post', id = "myform">
            	<br>
				<a class='label-formulario' style='font-size:130%;left:8%;'>Contactanos:</a>
				<br>
				<a class='label-formulario' style="font-size:17px;top:20%;left:8%;">Nombre:</a>
				<br>
				<input class='input-formulario' style='top:45%;left:35%;'type = 'text', name = 'correo', id = 'correo', placeholder = 'Tu nombre'/>
				<br>
				<a class='label-formulario' style="font-size:17px;top:20%;right:29%;">Correo:</a>
				<br>
				<input class='input-formulario' style='top:45%;right:15%;' type = 'text', name = 'password', id = 'password', placeholder = 'Correo@Dominio'/>
				<br>
            	<a class='label-formulario' style="font-size:17px;top:48%;left:8%;">Comentarios</a>
				<br>
				<textarea class='recuadro-texto' style="top:65%;left:35%;" id = "comentarios", name = 'comentarios', cols="40", rows="10"> </textarea>
				<br>
				<button class='boton-segundo' style='bottom:10%;right:8%;' href='javascript:void(0);' onclick = "return Enviar(comentarios)">Enviar</a>
			</form>
		</div>
