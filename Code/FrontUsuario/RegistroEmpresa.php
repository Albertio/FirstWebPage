	...
	<body>	
		...
		<div class="fondo">	
			<div class="container">
				...
				<form enctype = "multipart/form-data", onSubmit = "return Valida()", method = 'post', action = "Funciones/AltaEmpresa.php">
					<br>
					...
					<br>
					<a class="labels" style="color:#fff;">Comprobante Fiscal (pdf)</a>
					<br>
					<input type = "file", id = "cv", name = "cv">
					<br>
					<a class="labels" style="color:#fff;">Sitio Web:</a>
					<br>
