...
<html>
	...
	<body>
		...
		<?php
			...
			echo "<a class='boton-opcion' style='bottom:7%;right:18%;' href =\"usuarios_consultar.php?id=$id\">Regresar</a>
			...
			<input type = 'hidden' name = 'id', id = 'id', value = '$id'><br>
				...
				<a class='label-formulario' style='color:#fff;font-size:130%;top:35%;right:55%;'>Nombre:</a>
				<br>
				<input class='input-formulario' style='top:43%;right:46%;' type = 'text', name = 'nombre', id = 'nombre', value = '$nombre', />
				<br>

				<a class='label-formulario' style='color:#fff;font-size:130%;top:35%;right:36.5%;'>Correo:</a>
				<br>
				...
				<br>
				<div class='label-formulario' style='color:red;opacity: 0;transition: opacity 1s;font-size:130%;top:25%;right:15%;margin:auto;' id = 'mensajeCorreo'>El correo ya existe </div>
				<br>
				<a class='label-formulario' style='color:#fff;font-size:130%;top:35%;right:15%;'>Contraseña:</a>
					<br>
					<input  class='input-formulario' style='top:43%;right:9%;'type = 'text', name = 'password', id = 'password', , placeholder = '***********'/>
					<br>
				<br>

				<a class='label-formulario' style='color:#fff;font-size:130%;top:55%;right:51%;'>Foto de Perfil:</a>
					<br>
					<input style='position: fixed;top:62%;right:36%;' type = 'file', id = 'archivo', name = 'archivo'>
					<br>
				
					<a class='label-formulario' style='color:#fff;font-size:130%;top:55%;right:30%;'>CV:</a>
					<br>
					<input style='position: fixed;top:62%;right:8%;' type = 'file', id = 'archivo_cv', name = 'archivo_cv'>
					<br>

					<a class='label-formulario' style='color:#fff;font-size:130%;top:75%;right:58%;'>Url:</a>
					<br>
					...
					<div class='label-formulario' style='color:#1AF113;opacity: 0;font-size:130%;top:25%;right:15%;margin:auto;' id = 'mensajeExito', name = 'mensajeExito'>Registro Actualizado </div>
					<br>
				<input class='boton-opcion' style='border: 2px solid #00aeef;bottom:7%;right:7%;' type = 'submit', value = 'Guardar', id = 'Button', onclick = 'Valida($id,\"$nombre\",\"$correo\",\"$password\",\"$archivo\", \"$archivo_n\"); ' />
				</form></div>";
		?>
